...
WebUI.navigateToUrl('http://qa-interview.srcli.xyz/logout')

WebUI.delay(3)

WebUI.deleteAllCookies()

WebUI.navigateToUrl('http://qa-interview.srcli.xyz/login')

WebUI.delay(3)

if (true) {
    WebUI.verifyElementPresent(findTestObject('login_page/form_login'), 0)

    WebUI.verifyElementPresent(findTestObject('login_page/button_login'), 0)
}
